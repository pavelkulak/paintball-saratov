...
const SECTION_DECORS = {
  ...
  scenarios: { src: '/images/headers/Сценарии.png', width: 157 },
  reviews: { src: '/images/headers/Отзывы.png', width: 134 },
  faq: { src: '/images/headers/Вопросы_Ответы.png', width: 364 },
  formats: { src: '/images/headers/Игровые_форматы.png', width: 277 },
} as const
...
export function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <div className={twMerge('flex w-full flex-col gap-4', contentClassName)}>
        <h2
          id={titleId}
        ...
        {description ? (
          <p
            className={twMerge(
              'max-w-full text-[14px] leading-[1.2] font-medium text-current opacity-60 md:text-base',
              descriptionClassName,
            )}
          >
            {description}
