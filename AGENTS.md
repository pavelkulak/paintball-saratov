...
- Keep raw SQL writes disabled. The local OSPanel-only `bitrix_tinker` capability may execute explicitly requested D7/public API mutations; production and shared databases stay read-only.
